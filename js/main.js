...
$('bg-image-smartphone').css({'background':'url(' + selectPortraitImages + ')'});
...
get('bg-image-landscape').css({'background':'url(' + selectLandscapeImages + ')'});
...
$('bg-image-tablet').css({'background':'url(' + selectTabletImages + ')'});
...
$('bg-image-desktop').css({'background':'url(' + selectDesktopImages + ')'});
